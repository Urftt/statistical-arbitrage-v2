...
/**
 * Mantine theme for the StatArb Research platform.
 ...
 *
 * Ported from the Dash app's `MANTINE_PLOTLY_TEMPLATE` in
 * `src/statistical_arbitrage/app/layout.py`. Every value is kept
 * identical so charts look the same in the new Next.js frontend.
 */
